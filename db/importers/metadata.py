...
DEFAULT_METADATA: Dict[str, ExtractorMetadata] = {
    ...
    'docx': ExtractorMetadata(
        name='DOCX',
        version='1.0.0',
        description='DOCX format message extractor. Wrapper around docx_parser for extracting messages from Word documents.',
        author='DovOS Contributors',
        supported_extensions=['.docx', '.doc'],
        capabilities={'file_based': True, 'auto_detect': False},
        format_spec={
            'description': 'Microsoft Word DOCX format',
            'input_type': 'file',
            'structure': 'Word document with conversation text',
