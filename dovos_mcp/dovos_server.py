...
Provides search and fetch tools for LLMs to iteratively explore
the conversation archive, enabling Perplexity-style autonomous research.

Tools:
- search_conversations: Search for relevant conversations
- fetch_conversation: Retrieve full conversation content by ID
"""
...
async def main():
    ...
    try:
        logger.info("DovOS MCP Server starting...")

        # Initialize search service (manages its own database connections)
